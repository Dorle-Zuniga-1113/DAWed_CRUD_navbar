...
#cambiar los redirect por variable de inicio
    guardarcatalogo=Catalogo.objects.create(codigo=codigo,nombre=nombre,fecha_inicio=fecha_inicio,fecha_fin=fecha_fin,promocion=promocion,coleccion=coleccion,novedades=novedades)
