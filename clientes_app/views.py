...
#cambiar los redirect por variable de inicio CAMBIAR VARIABLES ARRIBA 
    guardarclientes=Clientes.objects.create(id_cliente=id_cliente,nombre=nombre,numero=numero,ciudad=ciudad,numCuenta=numCuenta,direccion=direccion,email=email)
...
def editarCliente(request):
    ...
    try:
        ...
        losclientes.email = request.POST["txtemail"]
